...
module.exports = (intentType) => {
  let timerSpeech = {
    ...
    speeches: {
      ...
      REQ_SET_REMINDERS_NOW: "Would you like me to set the reminders now, or later? ",
      REQ_PLAYBACK_REMINDERS_1: "Ok. I will set {{var.0}} reminders for you. ",
      REQ_PLAYBACK_REMINDERS_2: "{{var.0}} in {{var.1}} minutes. ",
